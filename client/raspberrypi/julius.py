...
def record():
    cmd = ['arecord', '-D', 'plughw:1,0', '-t', 'wav', '-d', '2',
           '-f', 'S16_LE', '-r', '16000', 'record.wav']
...
def julius():
    ...
    t = 'record.wav'
    cmd = ['/home/pi/julius-4.3.1/julius/julius', '-C',
           '/home/pi/julius-kits/dictation-kit-v4.3.1-linux/main.jconf', '-C',
           '/home/pi/julius-kits/dictation-kit-v4.3.1-linux/am-gmm.jconf',
           '-nostrip', '-outfile', '-palign', '-input', 'file']
